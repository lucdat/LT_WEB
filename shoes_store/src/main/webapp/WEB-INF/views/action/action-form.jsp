...
<div class="container">
    <div class="row">
      <div class="offset-lg-2 col-lg-8 col-sm-8 col-8 border rounded main-section">
        <h3 class="text-center text-inverse">ADD NEW ACTION</h3>
        <hr>

        <form:form cssClass="container" modelAttribute="action" method="post" action="add"  >
          <div class="row">
            <div class="col-lg-12 col-sm-12 col-12">
              <div class="form-group">
               ...
               <div class="form-group">
                <form:label path="url" cssClass="text-inverse">URL</form:label>
                <form:input path="url" cssClass="form-control"  placeholder="description" />
